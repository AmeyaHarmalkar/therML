...
def pairwise_to_h5( energy_dir, csv_file, out_file_path, matrix=False, overwrite=False, print_progress=False ):
    ...
    if( matrix ):
        pairwise_energy_set = h5_out.create_dataset(
            'pairwise_energy_mat', (num_seqs, max_total_len, max_total_len),
...
def cli():
    ...
    pairwise_to_h5( energy_dir, csv_filename, out_file, overwrite=overwrite, matrix=matrix )
